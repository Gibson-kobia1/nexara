...
const Hero = ({ showToast, onConnect }: any) => {
  const platforms = [
    ...
    { name: 'Bybit', icon: '/logos/Binance-Icon-Logo.wine.svg', desc: 'Unified trading account (UTA) access with a premium, native-feeling touchpoint.', status: 'Beta', cta: 'Link Platform' },
